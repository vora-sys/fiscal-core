...
| `PUBLICA` | `PublicaProvider` | SOAP | emitir, consultar lote, consultar por RPS, cancelar | obrigatória | custom override | Itajai/SC, Mafra/SC, Assu/RN | MEI vai para nacional | fluxo municipal com consulta posterior quando aplicável | Joinville/SC preservado como histórico/retroativo; validar novos municípios da mesma família |
