...
| `ABRASF_SHARED` | `AbrasfSharedProvider` | SOAP | emitir, consultar lote, consultar por RPS, cancelar, substituir | opcional (por override municipal) | base ABRASF 2.03 compartilhada | capitais e municípios migrados de DSF legado | MEI vai para nacional | depende de URL oficial municipal | homologação real por município ainda pendente |
