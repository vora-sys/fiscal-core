...
final class JoinvilleMunicipalDanfseRenderer implements MunicipalDanfseRendererInterface
{
    ...
    private function extractDocumentData(string $xmlNfse): array
    {
        ...
        return [
            ...
            'rps' => $this->firstNodeValue($xpath, [
                "//*[local-name()='IdentificacaoRps']/*[local-name()='Numero']",
            ]),
            'serie_rps' => $this->firstNodeValue($xpath, [
            ...
            'item_lista_servico' => $this->firstNodeValue($xpath, [
            ...
            'codigo_municipio' => $this->firstNodeValue($xpath, [
                "//*[local-name()='Servico']/*[local-name()='CodigoMunicipio']",
                "//*[local-name()='CodigoMunicipio']",
            ]),
            ...
            'aliquota' => $this->firstNodeValue($xpath, [
                "//*[local-name()='Servico']//*[local-name()='Aliquota']",
                "//*[local-name()='Aliquota']",
            ]),
...
<body>
  <div class="wrap">
    ...
    <table class="grid">
      ...
      <tr>
        <td><span class="label">RPS</span><div class="box mono">{$fields['rps']}</div></td>
        <td><span class="label">Serie RPS</span><div class="box mono">{$fields['serie_rps']}</div></td>
        <td><span class="label">Codigo municipio</span><div class="box mono">{$fields['codigo_municipio']}</div></td>
      </tr>
    </table>
    <h2>Prestador</h2>
    <table class="grid">
      <tr>
        ...
        <td><span class="label">CNPJ</span><div class="box mono">{$fields['prestador_documento']}</div></td>
    ...
    <table class="grid">
      <tr>
        <td><span class="label">Item lista servico</span><div class="box mono">{$fields['item_lista_servico']}</div></td>
        <td colspan="3"><span class="label">Discriminacao</span><div class="box">{$fields['discriminacao']}</div></td>
      </tr>
      <tr>
        <td><span class="label">Valor servicos</span><div class="box mono">{$fields['valor_servicos']}</div></td>
        <td><span class="label">Aliquota</span><div class="box mono">{$fields['aliquota']}</div></td>
